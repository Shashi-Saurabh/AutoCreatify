  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      <div className='text-center mb-6'>
        ...
        <p>Transform your ideas into stunning visuals with our AI-powered design tools.Write articles, generate images, and more with ease.</p>
      </div>
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        <button className='bg-white px-10 py-3  border border-gray-300 rounded-lg hover:scale-102 active:scale-95 transition cursor-pointer'>Watch Demo</button>
      </div>
