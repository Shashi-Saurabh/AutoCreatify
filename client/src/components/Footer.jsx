    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
               Experience the power of AI with QuickAi<br/>Transform your content creation with our suite of premium AI tools. From writing articles to generating images, we have everything you need to create stunning content effortlessly.
            </p>
        </div>
